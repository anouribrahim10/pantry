...
export default function Home() {
  ...
  return (
    ...
    <Box width="100vw" height="100vh" display="flex" justifyContent="center" alignItems="center" flexDirection="column" gap={2} bgcolor="#212d40">
              ...
              {name !== 'Item not found' && (
                <>
                  ...
                  <Stack direction="row" spacing={2}>
                    <Button variant="contained" onClick={() => addItem(name)} sx={{ bgcolor: "#22223b" }}>
                      Add
                    </Button>
                    <Button variant="contained" onClick={() => removeItem(name)} sx={{ bgcolor: "#22223b" }}>
                      Remove
                    </Button>
                    <Button variant="contained" onClick={() => handleUpdateClick(name)} sx={{ bgcolor: "#22223b" }}>
                      Update
                    </Button>
                  </Stack>
                </>
